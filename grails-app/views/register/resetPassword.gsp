...
<g:message code='spring.security.ui.resetPassword.title'/></title>
...
$(document).ready(function() {
	$('#password').focus();
    $('#resetPasswordFormContainer').resizable({
        resize: function(event, ui) {
            ui.size.height = $('#resetPasswordFormContainer').height();
            ui.size.width = $('#resetPasswordFormContainer').width();
        }
    });
});
</script>
