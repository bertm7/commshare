...
<g:message code='spring.security.ui.forgotPassword.title'/></title>
...
$(document).ready(function() {
	$('#username').focus();
    $('#forgotPasswordFormContainer').resizable({
        resize: function(event, ui) {
            ui.size.height = $('#forgotPasswordFormContainer').height();
            ui.size.width = $('#forgotPasswordFormContainer').width();
        }
    });
});
</script>
